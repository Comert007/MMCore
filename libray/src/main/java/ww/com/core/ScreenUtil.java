...
public class ScreenUtil {
    ...
    // Screen Params
    private static int BASE_SCREEN_WIDTH = 1080;
//    public static final int BASE_SCREEN_HEIGHT = 1920;
    ...
    /**
     * @param context
     * @param screenWidth 宽度基数
     */
    public static void init(Context context, int screenWidth) {
        BASE_SCREEN_WIDTH = screenWidth;
        init(context);
    }
    ...
    public static void scaleProcess(View view) {
        ...
        view.setLayoutParams(scaleParams(params));
